...
const CONSTANTS = {
    WIFIUP(WIFIUP_COLOR) {
        ...
        <path opacity="0.3" d="M15.1 14.5C15.1 11.7 17.3 9.5 20.1 9.5C20.5 9.5 20.8 9.5 21.1 9.6L23.2 7C22.8 6.7 18.3 3 11.6 3C4.9 3 0.4 6.7 0 7L11.6 21.5L15.1 17.2V14.5Z" fill=" hsl(${WIFIUP_COLOR}, 80%, 68%)"/>
        <path d="M4.40001 12.5L11.6 21.5L15.1 17.1V14.5C15.1 13.2 15.6 12 16.5 11.1C15.2 10.5 13.6 10 11.6 10C7.50001 10 4.80001 12.2 4.40001 12.5Z" fill=" hsl(${WIFIUP_COLOR}, 80%, 68% )"/>
        <path d="M18.1 13.4937V21H19.1V13.4937H20.6L18.6 11L16.6 13.4937H18.1Z" fill=" hsl(${WIFIUP_COLOR}, 80%, 68%)"/>
        </svg>`},
    WIFIDOWN(WIFIDOWN_COLOR) {
        return `<svg width="34" height="34" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path opacity="0.3" d="M15.3 14.5C15.3 11.7 17.5 9.5 20.3 9.5C20.7 9.5 21 9.5 21.3 9.6L23.4 7C23 6.7 18.5 3 11.8 3C5.1 3 0.599997 6.7 0.199997 7L11.8 21.5L15.3 17.2V14.5Z" fill=" hsl(${WIFIDOWN_COLOR}, 80%, 68%)"/>
        <path d="M4.60001 12.5L11.8 21.5L15.3 17.1V14.5C15.3 13.2 15.8 12 16.7 11.1C15.4 10.5 13.8 10 11.8 10C7.70001 10 5.00001 12.2 4.60001 12.5Z" fill=" hsl(${WIFIDOWN_COLOR}, 80%, 68%)"/>
        <path d="M19.3 18.5063V11H18.3V18.5063H16.8L18.8 21L20.8 18.5063H19.3Z" fill=" hsl(${WIFIDOWN_COLOR}, 80%, 68%)"/>
        </svg>`
    },
