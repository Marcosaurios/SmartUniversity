...
const CONSTANTS = {
    ...
    CROSS(CROSS_COLOR, HOVER) {
        ...
        <path d="M62 10.571L53.429 2L32 23.429L10.571 2L2 10.571L23.429 32L2 53.429L10.571 62L32 40.571L53.429 62L62 53.429L40.571 32z" fill="${readColor(CROSS_COLOR)}" ${/* HOVER ? 'onmouseover=this.style.fill="'+HOVER+'"; onmouseout=this.style.fill="'+CROSS_COLOR+'";' : ''*/ console.log("f") }></path></svg>
        `;
    }
}
